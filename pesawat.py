...
tap_to_play_font = 'Fonts/DroneflyRegular-K78LA.ttf'
game_over_msg = Message(WiDTH//2, 230, 30, 'Mampos',
                        game_over_font, putih, win)
score_msg = Message(WiDTH - 50, 28, 30, '0', score_font, merah, win)
final_score_msg = Message(WiDTH//2, 280, 30, '0', final_score_font, merah, win)
tap_to_play_msg = BlinkingText(
    WiDTH//2, HEIGHT - 60, 25, 'Tekan Untuk Main', tap_to_play_font, putih, win)
player_bullet_fx = pygame.mixer.Sound('assets/Sounds/gunshot.wav')
...
pygame.mixer.music.load('assets/Sounds/Spookie.mp3')
pygame.mixer.music.play(loops=-1)
pygame.mixer.music.set_volume(0.1)
bg = Background(win)
p = Player(144, HEIGHT - 80)
...
while run:
    ...
    if home_page:
        ...
        pygame.draw.circle(win, putih, (WiDTH//2, HEIGHT//2 + 50), 50, 2)
    ...
    if game_page:
        ...
        if p.alive:
            ...
            for bullet in player_bullet_group:
                player_hit = pygame.sprite.spritecollide(
                    bullet, enemy_group, False)
                for plane in player_hit:
        ...
        fuel_color = merah if p.fuel <= 40 else hijau
        pygame.draw.rect(
            win, fuel_color, (30, 20, p.fuel, 10), border_radius=4)
        pygame.draw.rect(win, putih, (30, 20, 100, 10), 2, border_radius=4)
        pygame.draw.rect(win, biru, (30, 32, p.health, 10), border_radius=4)
        pygame.draw.rect(win, putih, (30, 32, 100, 10), 2, border_radius=4)
        win.blit(plane_img, (10, 15))
    pygame.draw.rect(win, putih, (0, 0, WiDTH, HEIGHT), 5, border_radius=4)
    clock.tick(FPS)
